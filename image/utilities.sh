...
# imagemagick
run minimal_apt_get_install imagemagick libcurl4-openssl-dev libfontenc1 xfonts-75dpi \
    xfonts-base xfonts-encodings xfonts-utils fontconfig libxrender1 libmagickwand-dev

run minimal_apt_get_install ca-certificates fonts-liberation libappindicator3-1 libasound2 \
